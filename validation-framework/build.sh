...
function validateSchema {
  pajv -s ../titan_schemas/titanSideCars.json -r ../titan_schemas/cert.json -r ../titan_schemas/customTpls.json -r ../titan_schemas/egress.json -r ../titan_schemas/envoy.json -r ../titan_schemas/imageRegistry.json -r ../titan_schemas/ingress.json -r ../titan_schemas/integration.json -r ../titan_schemas/issuers.json -r ../titan_schemas/logs.json -r ../titan_schemas/opa.json -r ../titan_schemas/ratelimit_titanSideCars.json -r ../titan_schemas/validation.json -r ../titan_schemas/versionFunction.json -d values.yaml > tests/logs/schema_validation.log 2>&1
  if [[ $? -ne 0 ]]
  then
